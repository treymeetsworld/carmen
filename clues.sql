...
-- TODO: Write SQL query here
SELECT name  FROM city WHERE countrycode='SMR' AND NOT name='San Marino';
...
-- TODO: Write SQL query here
SELECT name  FROM city WHERE  name LIKE 'San Ma%'UNION SELECT name FROM country WHERE region='South America';
SELECT  countrycode  FROM city WHERE name='San Mart�n Texmelucan';
...
-- TODO: Write SQL query here
SELECT capital FROM country WHERE code='MEX';
SELECT name FROM city WHERE id=2515;
